...
namespace rpi_ws281x
{
	...
	{
		private static readonly uint DEFAULT_TARGET_FREQ = 800000;
		private static readonly int DEFAULT_DMA_CHANNEL = 10;

		/// <summary>
		/// Gamma Correction Factor 
		/// 1.0 = no correction, higher values result in dimmer midrange colors
		/// </summary>
		//private static readonly float DEFAULT_GAMMA_CORRECTION = 2.8f;
		private static readonly float DEFAULT_GAMMA_CORRECTION = 2.8f;
		/// <summary>
		/// Number of Colors (0 based) used in code (default is 255 - 8-bit colors)
		/// </summary>
		private static readonly int DEFAULT_COLOR_IN_MAX = 255;
		...
		/// </summary>
		private static readonly int DEFAULT_COLOR_OUT_MAX = 255;
